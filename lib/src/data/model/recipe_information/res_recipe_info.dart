...
ResRecipeInfo resRecipeInfoFromJson(String str) => ResRecipeInfo.fromJson(json.decode(str));
...
abstract class ResRecipeInfo with _$ResRecipeInfo {
    ...
    factory ResRecipeInfo.fromJson(Map<String, dynamic> json) => _$ResRecipeInfoFromJson(json);
}
